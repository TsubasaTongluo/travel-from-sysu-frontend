        ...
        <div class="modal-text">
          ...
          <div class="author-info">
            ...
            <button
                ...
                @click="handleActionClick('follow', selectedNote)"
            >
          ...
          <div class="modal-footer">
            ...
            <div class="lower-container">
              ...
              <div
                  ...
                  :class="{ 'centered': !isLoggedIn(), 'aligned-left': isLoggedIn() }"
              >
                <textarea
                    class="comment-input"
...
const handleActionClick = (action: string, note: Note) => {
  if (!isLoggedIn()) {
    ...
    if (action === 'like') {
      ...
      note.isFollow ? unfollow_note(note) : follow_note(note);
    }
  }
};
...
.modal-footer {
  ...
  .centered .comment-input:focus {
    outline: none; /* 移除 focus 的默认外边框 */
    border: none; /* 确保无边框 */
  }

  .aligned-left .comment-input {
    text-align: left;
    color: black;
